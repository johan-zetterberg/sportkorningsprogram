            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <section class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border dark:border-gray-700 p-4 md:p-6">
                    ...
                    <div class="mt-6 pt-6 border-t dark:border-gray-700">
                        <h3 class="font-medium text-gray-900 dark:text-gray-200 mb-2 text-sm md:text-base">${t('cant_find_comp')}</h3>
                        <p class="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-3">
                            ${t('cant_find_comp_desc')} (${user.email})
                        </p>
...
async function renderDashboard(container, compId, startNumber, user, unsubs = []) {
    ...
    try {
        ...
        const renderDressage = async () => {
            console.log('[PortalDebug] renderDressage start. AllJudges:', allJudges.length);
            ...
            validProtocols.forEach(p => {
                ...
                if (jr) {
                    ...
                    console.log('[PortalDebug] Failed to calculate result for judge:', jid, 'Program:', programKey);
                }
            });
            ...
            console.log('[PortalDebug] Final Judges List for display:', judgesList);
